...
public class Help {
    ...
    public static String getHelp() {
        return "<h1>FERRETERIA GALBA - COMANDOS DISPONIBLES</h1>"
                ...
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">ADDROL [NOMBRE: STRING, DESCRIPCION: STRING]</td> \n \n"
                + "</tr> \n \n"
                + "<tr> \n \n"
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">Actualizar rol</td> \n \n"
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">EDITROL [ID:NUMBER, NOMBRE: STRING, DESCRIPCION: STRING]</td> \n \n"
                + "</tr> \n \n"
                + "<tr> \n \n"
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">Eliminar rol</td> \n \n"
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">DELROL [ID: NUMBER]</td> \n \n"
                + "</tr> \n \n"
                + "<tr> \n \n"
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">Listar roles</td> \n \n"
                + "<td style=\"text-align: left; padding: 8px; border: 1px solid black;\">LISTROL [] || LISTROL [KEY, VALOR]</td> \n \n"
                + "</tr> \n \n"
                + "<tr> \n \n"
